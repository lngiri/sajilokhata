      ...
      {open && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={handleShare}
              className="w-full mt-3 py-3 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-xl text-sm font-medium flex items-center justify-center gap-2 active:scale-[0.98] transition-transform"
            >
