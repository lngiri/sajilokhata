      ...
      <div className="px-4 py-4 space-y-4">
        {loading ? (
          ...
          <div className="text-center py-12">
            <div className="w-16 h-16 mx-auto mb-4 bg-gray-50 dark:bg-gray-800/50 rounded-2xl flex items-center justify-center">
            ...
            <p className="text-[var(--color-text-muted)] text-sm">No products yet</p>
          ...
          <>
            {activeProducts.length > 0 && (
              <div className="space-y-2">
                <h2 className="text-xs font-semibold text-[var(--color-text-muted)] uppercase tracking-wide">Active ({activeProducts.length})</h2>
                {activeProducts.map((product) => (
                  <div key={product.id} className="bg-[var(--color-surface)] rounded-xl p-4 shadow-sm border border-[var(--color-border)]">
            ...
            {inactiveProducts.length > 0 && (
              <div className="space-y-2">
                <h2 className="text-xs font-semibold text-[var(--color-text-muted)] uppercase tracking-wide">Inactive ({inactiveProducts.length})</h2>
                {inactiveProducts.map((product) => (
                  <div key={product.id} className="bg-[var(--color-surface)] rounded-xl p-4 shadow-sm border border-[var(--color-border)] opacity-60">
                    <div className="flex items-center justify-between">
                      <div className="flex-1 min-w-0">
        ...
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/40" onClick={(e) => { if (e.target === e.currentTarget) resetForm(); }}>
          <div className="bg-[var(--color-surface)] rounded-t-2xl sm:rounded-2xl w-full max-w-md max-h-[85dvh] flex flex-col animate-slide-up">
            <div className="flex items-center justify-between px-6 pt-6 pb-2">
              ...
              <button onClick={resetForm} className="p-1 text-[var(--color-text-muted)] hover:text-gray-600 dark:hover:text-gray-300">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <div className="flex gap-3">
                <div className="flex-1">
                  ...
                  <input
                    ...
                    placeholder="0"
                    className="w-full mt-1 px-4 py-3 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 dark:text-white focus:ring-2 focus:ring-[var(--color-primary)]/20 focus:border-[var(--color-primary)] outline-none transition-all text-center"
                  />
                </div>
                <div className="flex-1">
                  ...
                  <select
                    ...
                    className="w-full mt-1 px-4 py-3 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 dark:text-white focus:ring-2 focus:ring-[var(--color-primary)]/20 focus:border-[var(--color-primary)] outline-none transition-all text-sm appearance-none"
                  >
                    {UNITS.map((u) => (
