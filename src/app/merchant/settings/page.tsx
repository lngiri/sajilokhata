          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-50 divide-y divide-gray-50">
            ...
            <div className="p-4">
              ...
              <div className="relative">
                ...
                <input
                  type="tel"
                  value={(authPhone || phone).replace(/^\+977/, "")}
                  disabled
                  className="w-full pl-14 pr-3.5 py-2.5 bg-gray-50 rounded-xl text-sm text-gray-500 border border-gray-100 cursor-not-allowed select-all"
                  tabIndex={-1}
                />
              </div>
              <p className="text-xs text-amber-600 mt-2 flex items-center gap-1.5">
                ...
                नम्बर परिवर्तन गर्नुपरेमा एडमिनलाई सम्पर्क गर्नुहोस्।
              </p>
            </div>
          </div>
