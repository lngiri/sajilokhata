    ...
    <div className="pb-20">
      ...
      <div className="px-4 py-6 space-y-6 print:hidden">
        ...
        <div className="text-center">
          <div className="w-16 h-16 mx-auto mb-3 rounded-2xl bg-gradient-to-br from-[var(--color-primary-surface)] to-[var(--color-primary-surface-dark)] flex items-center justify-center shadow-lg">
