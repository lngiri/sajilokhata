    ...
    <div className="min-h-dvh flex items-center justify-center bg-slate-100 dark:bg-gray-950 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="w-14 h-14 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-[var(--color-primary-surface)] to-[var(--color-primary-surface-dark)] flex items-center justify-center shadow-lg">
