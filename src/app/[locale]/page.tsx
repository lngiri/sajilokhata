...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: "Replace your paper khata. Track customer credit, shop-to-shop purchases and expenses on your phone. Customers check balances by scanning your QR — no app download. Start free.",
    openGraph: {
      title: "QR Hisab — Digital Khata for Nepali Shops",
      description: "Track customer credit, shop-to-shop purchases and expenses on your phone. Start free.",
      type: "website",
