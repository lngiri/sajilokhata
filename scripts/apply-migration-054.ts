...
const sql = readFileSync("supabase/migrations/054_add_expense_type.sql", "utf-8");

async function main() {
  console.log("\n=== APPLYING SCHEMA MIGRATION 054 VIA MANAGEMENT API ===\n");
