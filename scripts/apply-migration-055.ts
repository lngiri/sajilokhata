...
const sql = readFileSync("supabase/migrations/055_add_cash_in_type.sql", "utf-8");

async function main() {
  console.log("\n=== APPLYING SCHEMA MIGRATION 055 VIA MANAGEMENT API ===\n");
